...
Below is the kind of code I can use to prep preictor variables (i.e. averaging across readings). But need to check I know what I actually want!! 
...
Mostly the same, except: Parus major vs. Parus minor; Stigmatopelia chinensis vs. Spilopelia chinensis Next steps - align the two datasets. 
